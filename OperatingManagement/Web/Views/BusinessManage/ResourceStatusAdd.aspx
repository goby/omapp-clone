<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ResourceStatusAdd.aspx.cs" Inherits="OperatingManagement.Web.Views.BusinessManage.ResourceStatusAdd" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="BodyContent" runat="server">
    <table class="edit" style="width: 800px;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBeginTime" runat="server" onclick="setday(this);" CssClass="norText"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEndTime" runat="server" onclick="setday(this);" CssClass="norText"></asp:TextBox>
