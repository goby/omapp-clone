<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ZYSXAdd.aspx.cs" Inherits="OperatingManagement.Web.Views.BusinessManage.BDManage.ZYSXAdd" %>
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtScope" ClientIDMode="Static" CssClass="text" 
                ...
                <asp:RegularExpressionValidator ID="rvInt" runat="server" ClientIDMode = "Static"
                    ...
                    ForeColor="Red" ValidationExpression="\d{1,}-\d{1,10}"></asp:RegularExpressionValidator>
