<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CenterOutputPolicyEdit.aspx.cs" Inherits="OperatingManagement.Web.BusinessManage.CenterOutputPolicyEdit" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="BodyContent" runat="server">
    <table class="edit" style="width: 800px;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEffectTime" runat="server" onclick="new WdatePicker(this);" CssClass="norText"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDefectTime" runat="server" onclick="new WdatePicker(this);" CssClass="norText"></asp:TextBox>
