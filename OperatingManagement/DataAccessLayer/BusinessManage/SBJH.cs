...
{
    //设备工作计划
    public class SBJH : BaseEntity<int, SBJH>
    {
        private static readonly string GET_List_ByDate = "up_sbjh_getlist";
        private static readonly string Insert = "up_sbjh_insert";
