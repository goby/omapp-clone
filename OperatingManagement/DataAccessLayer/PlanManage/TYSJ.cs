...
namespace OperatingManagement.DataAccessLayer.PlanManage
{
    ...
    public class TYSJ : BaseEntity<int, TYSJ>
    {
        ...
        public FieldVerifyResult Update()
        {
            ...
            _database.SpExecuteNonQuery("up_TYSJ_update", new OracleParameter[]{
        ...
        public TYSJ SelectById(int id)
        {
            OracleParameter p = PrepareRefCursor();

            DataSet ds = _database.SpExecuteDataSet("up_TYSJ_selectbyid", new OracleParameter[]{
