...
(
       ...
       p_UseType TB_UseStatus.UseType%type,
...
begin  
       ...
       Insert into TB_UseStatus(USID,ResourceID,ResourceType,UseType,BeginTime,EndTime,UsedBy,UsedCategory,UsedFor,CanBeUsed,CreatedTime,CreatedUserID,UpdatedTime,UpdatedUserID) 
       Values(v_USID,p_ResourceID,p_ResourceType,p_UseType,p_BeginTime,p_EndTime,p_UsedBy,p_UsedCategory,p_UsedFor,p_CanBeUsed,p_CreatedTime,p_CreatedUserID,p_UpdatedTime,p_UpdatedUserID);
       commit;
       v_Result:=5; -- Success
