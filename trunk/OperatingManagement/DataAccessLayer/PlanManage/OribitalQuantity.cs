...
{
    public class OribitalQuantity : BaseEntity<int, OribitalQuantity>
    {
        ...
        /// <returns></returns>
        public DataSet GetOribitalQuantityListByDate(DateTime startDate, DateTime endDate)
        {
            DataSet ds = null;
            try
            {
