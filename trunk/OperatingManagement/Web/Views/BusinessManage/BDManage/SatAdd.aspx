...
<asp:Content ID="Content5" ContentPlaceHolderID="BodyContent" runat="server">
    <table class="edit" style="width: 800px;">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtMZB" runat="server" Width="300px" CssClass="text" MaxLength="9"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBMFSXS" runat="server" Width="300px" CssClass="text" MaxLength="9"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtD" runat="server" Width="300px" CssClass="text" MaxLength="9"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtL" runat="server" Width="300px" CssClass="text" MaxLength="9">0</asp:TextBox>
