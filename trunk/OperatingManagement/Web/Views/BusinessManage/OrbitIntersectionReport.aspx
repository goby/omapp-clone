<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OrbitIntersectionReport.aspx.cs" Inherits="OperatingManagement.Web.Views.BusinessManage.OrbitIntersectionReport" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="BodyContent" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rblFileOption" runat="server" RepeatDirection="Horizontal"
                    AutoPostBack="true" OnSelectedIndexChanged="rblFileOption_SelectedIndexChanged">
    ...
    <div id="divFillIn" runat="server" visible="false">
        <asp:Menu ID="menuCut" runat="server" Orientation="Horizontal" OnMenuItemClick="menuCut_MenuItemClick">
            <Items>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RadioButtonList ID="rblCutMainKAE" runat="server" RepeatDirection="Horizontal"
                                AutoPostBack="true" OnSelectedIndexChanged="rblCutMainKAE_SelectedIndexChanged">
